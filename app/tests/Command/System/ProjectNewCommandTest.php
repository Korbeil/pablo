...
YAML);
    ...
    public function testRegeneratesWhenProviderSetChanges(): void
    {
        ...
        $this->assertSame(0, $tester->getStatusCode());
        $this->assertArrayHasKey('lin-app', (new Config(new \Pablo\Config\GlobalConfig()))->loadProjects($this->projectsDir));
    ...
    public function testDoesNotRegenerateWhenProviderSetUnchanged(): void
    {
        ...
        $this->assertSame(0, $tester->getStatusCode());
        $this->assertArrayHasKey('second-gh', (new Config(new \Pablo\Config\GlobalConfig()))->loadProjects($this->projectsDir));
