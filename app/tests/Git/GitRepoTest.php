...
final class GitRepoTest extends TestCase
{
    ...
    {
        $wt = GitRepo::createWorktree($this->clone, $this->root, 'Korbeil/wk-9', 'main');
        $this->assertDirectoryExists($wt);
        $this->assertSame('Korbeil/wk-9', RepoHelper::git($wt, ['branch', '--show-current']));
        ...
        $this->assertNotContains('Korbeil/wk-9', $names);
